  ...
  switch (selectedAlert) {
    case AlertType.CONFLICTS:
      legendData.push({
        ...
        popoverInfo: <PopoverInfo dataSourceDescription={descriptions.conflicts} />,
        records: [
    ...
    case AlertType.HAZARDS:
      legendData.push({
        ...
        popoverInfo: <PopoverInfo dataSourceDescription={descriptions.hazards} />,
        records: [
  ...
  switch (selectedMapType) {
    case GlobalInsight.FOOD:
      legendData.push({
        ...
        startLabel: '0%',
        endLabel: 'above 40%',
        popoverInfo: <PopoverInfo dataSourceDescription={descriptions.fcs} />,
      });
      break;
    case GlobalInsight.RAINFALL:
      legendData.push({
        ...
        startLabel: '<40%',
        endLabel: '>180%',
        popoverInfo: <PopoverInfo dataSourceDescription={descriptions.rainfall} />,
      });
      break;
    case GlobalInsight.VEGETATION:
      legendData.push({
        ...
        startLabel: '<50%',
        endLabel: '>150%',
        popoverInfo: <PopoverInfo dataSourceDescription={descriptions.vegetation} />,
      });
      break;
    case GlobalInsight.IPC:
      if (!selectedCountryId) {
        legendData.push({
          ...
          startLabel: '0',
          endLabel: '>10',
          popoverInfo: <PopoverInfo dataSourceDescription={descriptions.ipcCh} />,
        });
      } else {
        legendData.push({
    ...
    case GlobalInsight.NUTRITION:
      if (!selectedCountryId) {
        legendData.push({
          ...
          popoverInfo: <PopoverInfo dataSourceDescription={descriptions.micronutrients} />,
          records: [
