 ...
 * renders the choropleth for the Nutrition Map for country view.
 ...
 * @param {regionLabelData} props.FeatureCollection<Geometry, GeoJsonProperties> - The region data of the country
