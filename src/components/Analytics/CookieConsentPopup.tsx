...
export function CookieConsentPopup() {
  ...
  return (
    <div className="fixed lg:bottom-4 mx-auto left-1/2 p-4 items-center -translate-x-1/2 rounded-md bg-content2 flex gap-2 justify-between z-cookieConsent w-full lg:w-2/5">
      <p className="text-xs">
